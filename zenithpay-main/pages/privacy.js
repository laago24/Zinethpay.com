...
function Privacy() {
  return (
    <Box>
      <Head>
        <title>Privacy Policy - ZenithPay</title>
        ...
        <Box>
          <Stack as={Container} maxW={"6xl"} mt={10}>
            <Heading
              ...
              mb={3}
            >
              <Text>Privacy Policy for ZenithPay</Text>
            </Heading>
            <Text mt={10}>
              At ZenithPay, accessible from https://zenithpay.network, one of our
              ...
              and recorded by ZenithPay and how we use it. If you have additional
          ...
          <Text p={4}>
            ZenithPay follows a standard procedure of using log files. These
          ...
          <Text p={4}>
            Like any other website, ZenithPay uses &apos; cookies&apos; . These
