...
function Privacy() {
  return (
    <Box>
      <Head>
        <title>Terms & Conditions - ZenithPay</title>
      ...
      <Container maxW={"6xl"} my={10}>
        <Box>
          <Stack as={Container} maxW={"6xl"} mt={10}>
            ...
            <Text my={10}>
              Welcome to ZenithPay These terms and conditions outline the rules
              and regulations for the use of ZenithPay&apos; s Website,
          ...
          <Text p={4}>
            We employ the use of cookies. By accessing ZenithPay, you agreed to
            use cookies in agreement with the ZenithPay&apos; s Privacy Policy. Most
          ...
          <Text p={4}>
            Unless otherwise stated, ZenithPay and/or its licensors own the
            intellectual property rights for all material on ZenithPay. All
            intellectual property rights are reserved. You may access this from
            ZenithPay for your own personal use subjected to restrictions set in
          ...
          <List spacing={3} textAlign="start" p={4}>
            <ListItem>
              ...
              Republish material from ZenithPay
            </ListItem>
            <ListItem>
              <ListIcon as={FaCheckCircle} color="yellow.500" />
              Sell, rent or sub-license material from ZenithPay
            </ListItem>

            <ListItem>
              <ListIcon as={FaCheckCircle} color="yellow.500" />
              Reproduce, duplicate or copy material from ZenithPay
            </ListItem>

            <ListItem>
              <ListIcon as={FaCheckCircle} color="yellow.500" />
              Redistribute content from ZenithPay
            </ListItem>
          </List>
        </Box>
      </Container>
