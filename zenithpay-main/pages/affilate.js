...
function Affilate() {
  return (
    <Box>
      <Head>
        <title>Affilates - ZenithPay</title>
        ...
        <Box p={4}>
          ...
          >
            <Heading
              ...
              mb={3}
            >
              <Text>ZenithPay Affiliate Network</Text>
            </Heading>
            <Text mt={10}>
              The ZenithPay platform welcomes you to become our partner and
          ...
          <Container maxW={"6xl"} mt={0}>
            <SimpleGrid columns={{ base: 1, md: 2, lg: 2 }}>
              <Box p={{ base: 2, md: 12 }} borderRadius={"10px"}>
                ...
                <Text mt={2}>
                  ZenithPay Affiliate Program offers you lifetime commission
                ...
                <List spacing={3} textAlign="start" mt={10}>
                  ...
                  <ListItem>
                    <ListIcon as={FaCheckCircle} color="yellow.500" />
                    Make a YouTube video and review ZenithPay and its benefits
                  </ListItem>
                </List>
              </Box>
